...
import rs.sbnz.book_recommender.security.auth.RestAuthenticationEntryPoint;
import rs.sbnz.book_recommender.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/books");
        web.ignoring().antMatchers(HttpMethod.GET, "/books/top/systemgrade");
        web.ignoring().antMatchers( "/books/*");
